...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-lalp4w.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-lalp4w.containers.anotherwebservice.com/
...
```
git clone git@github.com:Skrshat/container-lalp4w.git
cd container-lalp4w
```
...
```
docker attach container-lalp4w
```
